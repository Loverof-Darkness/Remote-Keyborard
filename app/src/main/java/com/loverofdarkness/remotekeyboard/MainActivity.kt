...
class MainActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) { super.onCreate(savedInstanceState); window.statusBarColor = Color.BLACK; requestBluetoothPermissions(); buildUi() }
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) { super.onRequestPermissionsResult(requestCode, permissions, grantResults); if (requestCode == REQUEST_BLUETOOTH && grantResults.isNotEmpty() && grantResults.all { it == PackageManager.PERMISSION_GRANTED }) loadPairedDevices() }
    ...
    private fun buildUi() {
        ...
        status = TextView(this).apply { text="● Disconnected"; textSize=16f; setTextColor(0xFFFF5555.toInt()); gravity=Gravity.CENTER; setPadding(0,16,0,16) }; root.addView(status)
        ...
        tabs.addView(Button(this).apply{text="Keyboard";setOnClickListener{keyboardPanel.visibility=android.view.View.VISIBLE;customPanel.visibility=android.view.View.GONE}},LinearLayout.LayoutParams(0,-2,1f))
        tabs.addView(Button(this).apply{text="Custom Keys";setOnClickListener{keyboardPanel.visibility=android.view.View.GONE;customPanel.visibility=android.view.View.VISIBLE}},LinearLayout.LayoutParams(0,-2,1f)); root.addView(tabs)
        ...
        customPanel=LinearLayout(this).apply{orientation=LinearLayout.VERTICAL;visibility=android.view.View.GONE}
    ...
    private fun keyButton(text:String,action:()->Unit)=Button(this).apply{this.text=text;setOnClickListener{if(hid?.isConnected()==true)action()}}
    ...
    private fun showAddCustomDialog(){
        ...
        val sequence=EditText(this).apply{hint="Keys: CTRL+C or CTRL+ALT+T";inputType=InputType.TYPE_CLASS_TEXT}
